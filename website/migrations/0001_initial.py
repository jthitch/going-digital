...
#
# Tables hero_images, testimonials, before_after_images, course_faqs are already
# created by courses.0002, 0004, 0006, and 0001 respectively. This migration only
# updates Django's app state so website owns these models; it does not CREATE TABLE.
